...
import (
	myresourcev1 "github.com/guanyu/k8s-controller-core-resource/pkg/apis/myresource/v1"
...
func (c *FakeMyResources) List(opts v1.ListOptions) (result *myresourcev1.MyResourceList, err error) {
	obj, err := c.Fake.
...
func (c *FakeMyResources) Create(myResource *myresourcev1.MyResource) (result *myresourcev1.MyResource, err error) {
	obj, err := c.Fake.
...
func (c *FakeMyResources) Update(myResource *myresourcev1.MyResource) (result *myresourcev1.MyResource, err error) {
	obj, err := c.Fake.
...
func (c *FakeMyResources) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *myresourcev1.MyResource, err error) {
	obj, err := c.Fake.
